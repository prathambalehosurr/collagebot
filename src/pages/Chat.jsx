...
import { Send, LogOut, Settings, Bot, User, Sparkles, TrendingUp } from 'lucide-react';
...
export default function Chat() {
    ...
    async function handleSend(e) {
        ...
        try {
            ...
            const debugErrorMessage = `Error: ${error.message || 'Unknown error'}`;
            setMessages(prev => [...prev, { role: 'assistant', content: debugErrorMessage }]);
        } finally {
            setLoading(false);
        }
    }
